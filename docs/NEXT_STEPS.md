...
| Exact match (<0.5pp) | 60.3% |
| Within 2pp | 61.3% |
| Within 5pp | 65.7% |
| Mean abs diff | 6.2 pp |

## Tier 1: High Impact

### 1. Canada/Mexico Non-USMCA Stacking (~22K products)
- **Gap**: CA 44.6% exact match (+4.2pp mean diff), MX 44.1% (+2.8pp)
...
- **Fix**: Verify stacking rules for CA/MX non-USMCA products.
...
### 4. China 301 Biden + 232 Stacking (~550 products, -43pp)
- **Gap**: TPC=93%, ours=50%
...
### 5. Section 301 Exclusions (9903.89.xx) -- 61 remaining products
...
### 6. TPC Country Coverage Alignment
